                ...
                if progress >= 1.0 then
                    ...
                    if shouldExplode then
                        ...
                        if data.sourceServerId == myServerId and data.rockIndex == 1 then
                            TriggerServerEvent('th_petrosa:applyDamage', impactPos, level)
                        end
...
RegisterNetEvent('th_petrosa:prepareProjectile', function(spellLevel)
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('th_petrosa:broadcastProjectile', finalTargetCoords, spellLevel)
...
RegisterNetEvent('th_petrosa:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('th_petrosa:fireProjectile', function(sourceServerId, targetCoords, spellLevel)
    local casterPlayer <const> = GetPlayerFromServerId(sourceServerId)
    if casterPlayer == -1 then 
        return 
    end
