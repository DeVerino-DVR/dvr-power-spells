...
RegisterNetEvent('dvr_wallis:prepareCast', function(spellLevel)
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('dvr_wallis:broadcastWall', targetCoords, direction, spellLevel)
...
RegisterNetEvent('dvr_wallis:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('dvr_wallis:spawnWall', function(sourceServerId, targetCoords, direction, spellLevel)
