...
RegisterNetEvent('th_bloodpillar:levitationExpired', function(targetServerId)
...
RegisterNetEvent('th_bloodpillar:applyExpulsionDamage', function(impactCoords, spellLevel)
    local _source <const> = source
...
local function RegisterBloodpillarModule()
    ...
    local moduleData <const> = {
        ...
        onCast = function(hasItem, raycast, source, target, level)
            ...
            if not activeCasts[source] then
                ...
                TriggerClientEvent('th_bloodpillar:startLevitation', -1, target, source, duration, height, spellLevel)
                ...
                TriggerClientEvent('th_bloodpillar:playSecondAnim', source)
                TriggerClientEvent('th_bloodpillar:otherPlayerSecondAnim', -1, source)
                TriggerClientEvent('th_bloodpillar:expelTarget', -1, source, target, spellLevel)
    ...
    print('[th_bloodpillar] Module enregistre avec succes')
end
