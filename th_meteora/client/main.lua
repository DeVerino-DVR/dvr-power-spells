                ...
                if currentTime >= data.endTime then
                    if DoesEntityExist(data.prop) then
                        ...
                        if isLocalCaster then
                            TriggerServerEvent('th_meteora:applyMeteorDamage', impactCoords, level, data.meteorIndex)
                        end
...
local function PlayCastSound(coords)
    ...
    -- id = ('th_meteora_cast_%s'):format(GetGameTimer()),
...
RegisterNetEvent('th_meteora:prepareCast', function(spellLevel)
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('th_meteora:broadcastSignalProjectile', targetCoords, spellLevel)
...
RegisterNetEvent('th_meteora:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('th_meteora:spawnSignalProjectile', function(sourceServerId, targetCoords, spellLevel)
