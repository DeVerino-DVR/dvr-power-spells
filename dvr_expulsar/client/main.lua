...
RegisterNetEvent('dvr_repulsar:playSound', function(sourceServerId, casterCoords)
...
RegisterNetEvent('dvr_repulsar:castSpell', function(settings, level, targetServerId)
    ...
    TriggerServerEvent('dvr_repulsar:applyForce', targetId, velocity)
...
RegisterNetEvent('dvr_repulsar:receiveForce', function(velocity)
...
RegisterNetEvent('dvr_repulsar:visualForce', function(targetServerId, targetNetId, velocity)
