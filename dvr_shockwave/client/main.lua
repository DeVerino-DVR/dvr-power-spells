...
RegisterNetEvent('dvr_shockwave:prepare', function()
    local ped = cache.ped
    PlayWandFx(ped)
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('dvr_shockwave:trigger', targetCoords)
...
RegisterNetEvent('dvr_shockwave:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('dvr_shockwave:fire', function(sourceServerId, targetCoords)
