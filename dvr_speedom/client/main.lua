...
RegisterNetEvent('dvr_speedom:prepareSpeed', function(targetId)
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('dvr_speedom:applySpeed', targetServerId)
    end)
end)

RegisterNetEvent('dvr_speedom:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('dvr_speedom:grantSpeed', function(duration, fromOther)
