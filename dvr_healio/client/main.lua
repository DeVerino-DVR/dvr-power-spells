...
RegisterNetEvent('dvr_healio:prepareProjectile', function()
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('dvr_healio:broadcastProjectile', finalTargetCoords)
...
RegisterNetEvent('dvr_healio:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('dvr_healio:fireProjectile', function(sourceServerId, targetCoords, level)
    local casterPlayer <const> = GetPlayerFromServerId(sourceServerId)
    if casterPlayer == -1 then 
        return 
    end
