                        ...
                        if inZone then
                            ...
                            if now - lastTick >= tickRate then
                                ...
                                if not burningPlayers[myServerId] then
                                    ...
                                    TriggerServerEvent('dvr_abyrion:playerBurning', myServerId, burnDuration)
...
RegisterNetEvent('dvr_abyrion:prepare', function(level, isToggleOff)
    local ped = cache.ped
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('dvr_abyrion:cast', castCoords, level)
...
RegisterNetEvent('dvr_abyrion:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('dvr_abyrion:spawnCircle', function(sourceServerId, coords, level, circleId)
...
RegisterNetEvent('dvr_abyrion:destroyCircle', function(circleId, animated)
    CleanupCircle(circleId, animated)
end)

RegisterNetEvent('dvr_abyrion:showBurningFx', function(targetServerId, duration)
