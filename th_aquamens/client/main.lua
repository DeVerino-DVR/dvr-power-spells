...
RegisterNetEvent('th_aquamens:prepareTeleport', function()
    local ped = cache.ped
    PlayWandFx(ped)
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('th_aquamens:doTeleport', startCoords, target)
    end)
end)

RegisterNetEvent('th_aquamens:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('th_aquamens:runTeleport', function(sourceServerId, startCoords, targetCoords)
