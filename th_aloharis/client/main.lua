...
RegisterNetEvent('th_aloharis:onCast', function(spellLevel)
    ...
    TriggerServerEvent('th_aloharis:unlockDoor', payload)
end)
...
RegisterNetEvent('th_aloharis:doorUnlocked', function(data)
    local messages = Config.Messages or {}
    if not data then
        return
    end
