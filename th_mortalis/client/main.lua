...
RegisterNetEvent('th_mortalis:prepareProjectile', function()
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('th_mortalis:broadcastProjectile', finalTargetCoords)
...
RegisterNetEvent('th_mortalis:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('th_mortalis:fireProjectile', function(sourceServerId, targetCoords)
    local casterPlayer <const> = GetPlayerFromServerId(sourceServerId)
    if casterPlayer == -1 then 
        return 
    end
