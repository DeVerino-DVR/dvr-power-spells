...
RegisterNetEvent('dvr_desarmis:onCast', function(targetId)
...
RegisterNetEvent('dvr_desarmis:disarmed', function()
    local messages = Config.Messages or {}
...
RegisterNetEvent('dvr_desarmis:playImpact', function(targetId)
    if not targetId or targetId <= 0 then
        return
    end
