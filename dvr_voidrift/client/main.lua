...
RegisterNetEvent('dvr_voidrift:prepareRift', function()
    local ped = cache.ped
    PlayWandFx(ped)
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('dvr_voidrift:spawnRift', targetCoords)
...
RegisterNetEvent('dvr_voidrift:otherPlayerCasting', function(sourceServerId)
    local myId = GetPlayerServerId(PlayerId())
...
RegisterNetEvent('dvr_voidrift:createRift', function(sourceServerId, targetCoords)
