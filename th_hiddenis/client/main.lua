...
RegisterNetEvent('th_hiddenis:syncHidden', function(serverId, hidden)
    if hidden then
...
local function ClearEffect()
    ...
    TriggerServerEvent('th_hiddenis:setHidden', false)
    activeEffect = nil
...
RegisterNetEvent('th_hiddenis:prepareHidden', function(targetId, profile)
    CreateThread(function()
        Wait(800)
        ...
        TriggerServerEvent('th_hiddenis:applyToTarget', targetServerId, profile)
    end)
end)

RegisterNetEvent('th_hiddenis:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('th_hiddenis:apply', function(profileOrDuration, alpha)
