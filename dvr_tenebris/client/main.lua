        ...
        for prop, data in pairs(projectileProps) do
            if DoesEntityExist(prop) then
                ...
                if progress >= 1.0 then
                    ...
                    TriggerServerEvent('dvr_tenebris:onImpact', impactCoords, data.spellLevel)
...
RegisterNetEvent('dvr_tenebris:playImpactFx', function(impactCoords)
...
RegisterNetEvent('dvr_tenebris:createProjectile', function(startCoords, targetCoords, sourceServerId, spellLevel)
    local casterPed = nil
...
--- Apply knockback
RegisterNetEvent('dvr_tenebris:applyKnockback', function(impactCoords, level, forceUp, forceHorizontal, ragdollTime)
...
--- Prepare and cast
RegisterNetEvent('dvr_tenebris:prepareCast', function(spellLevel)
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('dvr_tenebris:prepareImpact', impactCoords, spellLevel)
        ...
        TriggerServerEvent('dvr_tenebris:createProjectile', startPos, impactCoords, spellLevel)
...
RegisterNetEvent('dvr_tenebris:otherPlayerCasting', function(sourceServerId)
