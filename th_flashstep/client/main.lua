...
RegisterNetEvent('th_flashstep:prepareDash', function()
    local ped = cache.ped
    PlayWandFx(ped)
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('th_flashstep:dash', targetCoords)
        Wait(500)
        StopWandFx(ped)
    end)
end)

RegisterNetEvent('th_flashstep:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('th_flashstep:doDash', function(sourceServerId, targetCoords)
