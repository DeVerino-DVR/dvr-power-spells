...
RegisterNetEvent('dvr_fumania:prepareSwap', function()
    local ped = cache.ped
    PlayWandFx(ped)
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('dvr_fumania:swapPositions', targetId, sourceCoords, targetCoords)
    end)
end)

RegisterNetEvent('dvr_fumania:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('dvr_fumania:doSwap', function(sourceId, targetId, sourceCoords, targetCoords)
