...
local function CreateImpactExplosion(coords, spellLevel)
    ...
    -- Note: EMP particle is played via network event 'th_impulsio:playImpactFx' for all clients
end
        ...
        for prop, data in pairs(projectileProps) do
            if DoesEntityExist(prop) then
                ...
                if progress >= 1.0 then
                    ...
                    TriggerServerEvent('th_impulsio:onImpact', impactCoords, data.spellLevel)
...
RegisterNetEvent('th_impulsio:createProjectile', function(startCoords, targetCoords, sourceServerId, spellLevel)
...
RegisterNetEvent('th_impulsio:playImpactFx', function(impactCoords)
...
RegisterNetEvent('th_impulsio:applyKnockback', function(impactCoords, level, forceUp, forceHorizontal, ragdollTime)
...
RegisterNetEvent('th_impulsio:prepareCast', function(spellLevel)
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('th_impulsio:prepareImpact', impactCoords, spellLevel)
        ...
        TriggerServerEvent('th_impulsio:createProjectile', startPos, impactCoords, spellLevel)
...
RegisterNetEvent('th_impulsio:otherPlayerCasting', function(sourceServerId)
