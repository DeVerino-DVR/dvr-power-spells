...
RegisterNetEvent('dvr_ravivio:prepareCast', function()
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('dvr_ravivio:broadcastProjectile', finalTargetCoords)
...
RegisterNetEvent('dvr_ravivio:fireProjectile', function(sourceServerId, targetCoords, targetPlayerId)
...
RegisterNetEvent('dvr_ravivio:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('dvr_ravivio:playReviveEffect', function(targetServerId)
                    ...
                    if currentTime < data.endTime then
                        ...
                        if data.casterServerId and data.casterServerId == myServerId then
                            if data.targetServerId and data.targetServerId > 0 then
                                TriggerServerEvent('dvr_ravivio:projectileHit', data.targetServerId)
                            end
                        end
