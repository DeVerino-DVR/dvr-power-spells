...
RegisterNetEvent('dvr_signalis:prepareProjectile', function()
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('dvr_signalis:broadcastProjectile', finalTargetCoords)
...
RegisterNetEvent('dvr_signalis:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('dvr_signalis:fireProjectile', function(sourceServerId, targetCoords)
    local casterPlayer <const> = GetPlayerFromServerId(sourceServerId)
    if casterPlayer == -1 then 
        return 
    end
