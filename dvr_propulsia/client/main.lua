...
RegisterNetEvent('dvr_propulsia:applySelfPropulsion', function()
    if HasProtheaShield() then return end
...
RegisterNetEvent('dvr_propulsia:applyKnockback', function(explosionCoords)
    if HasProtheaShield() then return end
...
RegisterNetEvent('dvr_propulsia:playExplosionFx', function(coords, casterServerId)
...
RegisterNetEvent('dvr_propulsia:prepareCast', function()
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('dvr_propulsia:trigger', explosionCoords)
...
RegisterNetEvent('dvr_propulsia:otherPlayerCasting', function(sourceServerId)
