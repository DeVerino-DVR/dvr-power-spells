...
RegisterNetEvent('th_putrefactio:prepareProjectile', function()
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('th_putrefactio:broadcastProjectile', finalTargetCoords)
...
RegisterNetEvent('th_putrefactio:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('th_putrefactio:fireProjectile', function(sourceServerId, targetCoords)
    local casterPlayer <const> = GetPlayerFromServerId(sourceServerId)
    if casterPlayer == -1 then
        return
    end
...
RegisterNetEvent('th_putrefactio:teleportTarget', function()
