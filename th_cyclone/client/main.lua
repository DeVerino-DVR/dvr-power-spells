...
RegisterNetEvent('th_cyclone:prepare', function(level)
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('th_cyclone:trigger', targetCoords)
...
RegisterNetEvent('th_cyclone:otherPlayerCasting', function(sourceServerId, level)
...
RegisterNetEvent('th_cyclone:createCyclone', function(sourceServerId, targetCoords, level)
