...
RegisterNetEvent('dvr_fumora:prepare', function()
    local ped = cache.ped
    PlayWandFxOnPed(ped)
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('dvr_fumora:cast', coords)
    end)
end)

RegisterNetEvent('dvr_fumora:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('dvr_fumora:spawn', function(screenId, coords, durationMs)
