...
RegisterNetEvent('dvr_altis:prepareJump', function(targetId, spellLevel)
    ...
    CreateThread(function()
        ...
        TriggerServerEvent('dvr_altis:applyJump', targetServerId, spellLevel)
    end)
end)

RegisterNetEvent('dvr_altis:otherPlayerCasting', function(sourceServerId)
...
RegisterNetEvent('dvr_altis:grantJump', function(duration, fromOther)
