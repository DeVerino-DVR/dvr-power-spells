...
RegisterNetEvent('th_exposare:areaReveal', function(centerCoords, radius)
...
RegisterNetEvent('th_exposare:forceReveal', function()
    ...
    if myPed and DoesEntityExist(myPed) then
        ...
        TriggerEvent('th_hiddenis:apply', 0, 255)
...
RegisterNetEvent('th_exposare:revealPlayer', function(targetServerId, casterServerId)
...
RegisterNetEvent('th_exposare:showRevealEffect', function(targetServerId)
    local myServerId = GetPlayerServerId(PlayerId())
